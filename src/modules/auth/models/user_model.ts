...
where_sd_users_profile_id(db1: knex, profile_id: any) {
        return db1('sd_users')
...
where_sd_users_profile_id_update(db1: knex, user_id: any, data: any) {
        return db1('sd_users')
        .where('user_id', user_id)
        .update(data)
    }
where_sd_users_profile_id_remove(db1: knex, profile_id: any) {
        return db1('sd_users')
        .where('profile_id', profile_id)
        .del()
    }
